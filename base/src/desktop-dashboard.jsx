...
function DesktopDashboard() {
  ...
  const segments = D.breakdown.map((r) => ({
    pct: r.pct,
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <Btn variant="coral" size="sm" icon={I.minus(12)}>
              Expense
            </Btn>
            <Btn variant="teal" size="sm" icon={I.plus(12)}>
              Earning
            </Btn>
            <Btn variant="light" size="sm" icon={I.upload(14)}>
              Upload receipt
            </Btn>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            >
              ...
              <span
                style={{ marginLeft: "auto", fontFamily: T.mono, fontSize: 10 }}
              >
                ⌘K
              </span>
            </div>
            <Btn variant="light" icon={I.filter(13)}>
              April
            </Btn>
            <Btn variant="primary" icon={I.plus(12)}>
              Add
            </Btn>
          </div>
        </div>
                ...
                center={
                  <div style={{ textAlign: "center" }}>
                    ...
                    <Num size={22} style={{ marginTop: 2 }}>
                      {fmtCOPraw(D.totals.spent / 1000).replace(/\.\d+$/, "")}k
                    </Num>
                  </div>
                }
              />
              ...
              >
                {D.breakdown.slice(0, 5).map((r) => (
                  ...
                  >
                    ...
                    <Mono size={12} style={{ width: 86, textAlign: "right" }}>
                      {fmtCOPraw(r.amount)}
                    </Mono>
                  </div>
                ))}
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: T.muted, lineHeight: 1.45 }}>
                  PDFs, photos, bank statements — the AI reads them and files
                  the entry.
                </div>
              </div>
              <Btn variant="light" size="sm" icon={I.upload(12)}>
                Upload
              </Btn>
            </div>
          </div>
